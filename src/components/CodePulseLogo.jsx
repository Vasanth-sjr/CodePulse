...
export default function CodePulseLogo({ size = 32, className = '' }) {
  return (
    ...
    >
      ...
      <circle cx="50" cy="50" r="30" fill="#34D399" opacity="0.1" filter="blur(15px)" />

      {/* Circuit lines with Neon Glow */}
      <g className="circuit-line" fill="none" stroke="#10B981" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" filter="url(#neonGlow)">
        {/* Left circuits */}
      ...
      {/* Circuit Dots */}
      <circle cx="30" cy="35" r="2.5" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      <circle cx="38" cy="68" r="2.5" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      <circle cx="20" cy="20" r="2.5" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      <circle cx="25" cy="80" r="2.5" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      
      <circle cx="70" cy="35" r="2.5" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      <circle cx="62" cy="68" r="2.5" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      <circle cx="80" cy="20" r="2.5" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      <circle cx="75" cy="80" r="2.5" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />

      <circle cx="35" cy="15" r="2" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      <circle cx="65" cy="15" r="2" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      <circle cx="35" cy="85" r="2" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
      <circle cx="65" cy="85" r="2" fill="#10B981" className="circuit-dot" filter="url(#neonGlow)" />
